...
rm -f "$BIN_DIR/imthemousenow" "$BIN_DIR/imthemousenow-steer" "$BIN_DIR/imthemousenow-regions" "$BIN_DIR/imthemousenow-panic" "$BIN_DIR/imthemousenow-config" "$BIN_DIR/imthemousenow-osd" "$BIN_DIR/imthemousenow-menu"
